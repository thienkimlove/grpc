...
var file_service_proto_rawDesc = []byte{
	...
	0x07, 0x63, 0x6f, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x32, 0xba, 0x01, 0x0a, 0x0e, 0x4c, 0x69, 0x73,
	...
	0x2f, 0x71, 0x75, 0x61, 0x6e, 0x64, 0x6d, 0x12, 0x4c, 0x0a, 0x0f, 0x4c, 0x69, 0x73, 0x74, 0x69,
	0x6e, 0x67, 0x52, 0x65, 0x67, 0x69, 0x73, 0x74, 0x65, 0x72, 0x12, 0x1a, 0x2e, 0x6c, 0x69, 0x73,
	0x74, 0x69, 0x6e, 0x67, 0x2e, 0x76, 0x31, 0x2e, 0x4c, 0x69, 0x73, 0x74, 0x69, 0x6e, 0x67, 0x52,
	0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x1b, 0x2e, 0x6c, 0x69, 0x73, 0x74, 0x69, 0x6e, 0x67,
	0x2e, 0x76, 0x31, 0x2e, 0x4c, 0x69, 0x73, 0x74, 0x69, 0x6e, 0x67, 0x52, 0x65, 0x73, 0x70, 0x6f,
...
var file_service_proto_depIdxs = []int32{
	...
	0, // 1: listing.v1.ListingService.ListingRegister:input_type -> listing.v1.ListingRequest
	1, // 2: listing.v1.ListingService.ListingRq:output_type -> listing.v1.ListingResponse
	1, // 3: listing.v1.ListingService.ListingRegister:output_type -> listing.v1.ListingResponse
...
type ListingServiceClient interface {
	...
	ListingRegister(ctx context.Context, in *ListingRequest, opts ...grpc.CallOption) (*ListingResponse, error)
}
...
func (c *listingServiceClient) ListingRegister(ctx context.Context, in *ListingRequest, opts ...grpc.CallOption) (*ListingResponse, error) {
	out := new(ListingResponse)
	err := c.cc.Invoke(ctx, "/listing.v1.ListingService/ListingRegister", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ListingServiceServer interface {
	...
	ListingRegister(context.Context, *ListingRequest) (*ListingResponse, error)
}
...
func (*UnimplementedListingServiceServer) ListingRegister(context.Context, *ListingRequest) (*ListingResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ListingRegister not implemented")
}
...
func _ListingService_ListingRegister_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ListingRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ListingServiceServer).ListingRegister(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/listing.v1.ListingService/ListingRegister",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ListingServiceServer).ListingRegister(ctx, req.(*ListingRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _ListingService_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ListingRegister",
			Handler:    _ListingService_ListingRegister_Handler,
		},
	},
